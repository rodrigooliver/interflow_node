...
import { createMessageRoute, deleteMessageRoute, updateMessageRoute } from '../controllers/chat/message-handlers.js';
...
router.put('/:chatId/message/:messageId', updateMessageRoute);
